        ...
        <div className="glass rounded-3xl p-8 border border-zinc-800">
          <div className="prose prose-invert max-w-none">
            ...
            <p className="text-zinc-300 mb-6">
              By accessing and using Foodly, you accept and agree to be bound by
            ...
            <p className="text-zinc-300 mb-4">
              Permission is granted to temporarily use Foodly for personal,
            ...
            <p className="text-zinc-300 mb-6">
              You are responsible for any content you post, including restaurant
              recommendations, reviews, and location data. You grant Foodly a
            ...
            <p className="text-zinc-300 mb-6">
              ...
              To the fullest extent permitted by law, Foodly excludes all
            ...
            <p className="text-zinc-300 mb-6">
              In no event shall Foodly or its suppliers be liable for any
              damages (including, without limitation, damages for loss of data
              or profit, or due to business interruption) arising out of the use
              or inability to use the materials on Foodly's website.
            </p>
            ...
            <p className="text-zinc-300 mb-6">
              The materials appearing on Foodly's website could include
              technical, typographical, or photographic errors. Foodly does not
            ...
            <p className="text-zinc-300 mb-6">
              Foodly may revise these terms of service for its website at any
